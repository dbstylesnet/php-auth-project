...
class RectangleWithCircleIntersectorTest extends TestCase
{
    ...
    public function testIsIntersect() 
    {
        ...
        $this->assertEquals(false, $intersector->isIntersect($b, $b));
        $this->assertEquals(false, $intersector->isIntersect($a, $a));
    }
    ...
    public function testIsIntersect2()
    {
        ...
        $this->assertEquals(false, $intersector->isIntersect($a1, $b1));
    }
